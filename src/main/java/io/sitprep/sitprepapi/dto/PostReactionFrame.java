 ...
 *
 * <p>Mirrors {@link GroupPostReactionFrame} exactly (modulo postId → postId,
...
public record PostReactionFrame(
    ...
    public static PostReactionFrame add(Long postId, String groupId, String zipBucket,
                                        String emoji, String userEmail, Instant at) {
        return new PostReactionFrame("reaction", postId, groupId, zipBucket, emoji, userEmail, "add", at);
    }

    public static PostReactionFrame remove(Long postId, String groupId, String zipBucket,
                                           String emoji, String userEmail, Instant at) {
        return new PostReactionFrame("reaction", postId, groupId, zipBucket, emoji, userEmail, "remove", at);
    }
}
