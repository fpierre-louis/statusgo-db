...
public record CommunityDiscoverDto(
    ...
    // The mutual face-stack identity is now the shared top-level
    // io.sitprep.sitprepapi.dto.MemberAvatar — same package, so the
    // unqualified `MemberAvatar` references above still resolve. Unified
    // 2026-06-11 (was a verbatim copy of the Me-side record).
