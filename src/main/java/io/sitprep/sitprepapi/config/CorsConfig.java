...
import static io.sitprep.sitprepapi.constant.Constant.X_REQUESTED_WITH;
...
public class CorsConfig {
    ...
    public CorsFilter corsFilter(){
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:4200", "http://newsitprep.us-east-1.elasticbeanstalk.com", "https://statusnow.app", "https://www.statusnow.app"));
